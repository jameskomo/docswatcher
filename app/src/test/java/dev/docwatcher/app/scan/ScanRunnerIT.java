...
import dev.docwatcher.app.support.LocalRepo;
...
class ScanRunnerIT extends PostgresTest {
  ...
  void scanStoresContractsOpensFindingWithIssueThenClosesItWhenTheCodeIsGone() throws Exception {
    ...
    assertThat(github.calls("createIssue").getFirst().args()[3].toString()).contains("models.yaml:1").contains("docwatcher:fix");
