...
/** DocWatcher command line. Dependabot for the APIs you call, not the packages you install. */
@Command(
    name = "docwatcher",
    mixinStandardHelpOptions = true,
    version = "docwatcher 0.1.0",
...
public final class DocWatcher implements Callable<Integer> {

  public static void main(String[] args) {
    System.exit(new CommandLine(new DocWatcher()).execute(args));
  }
